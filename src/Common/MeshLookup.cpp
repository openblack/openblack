...
MeshLookup<Villager::Type, Villager::TypeId> openblack::villagerMeshLookup {
    {{V::Ethnicity::AZTEC, V::LifeStage::Adult, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonAztecMaleA1},
    {{V::Ethnicity::AZTEC, V::LifeStage::Adult, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonAztecFemaleA1},
    {{V::Ethnicity::AZTEC, V::LifeStage::Child, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonBoyTan1},
    {{V::Ethnicity::AZTEC, V::LifeStage::Child, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonGirlTan1},
    {{V::Ethnicity::CELTIC, V::LifeStage::Adult, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonCelticMaleA1},
    {{V::Ethnicity::CELTIC, V::LifeStage::Adult, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonCelticFemaleA1},
    {{V::Ethnicity::CELTIC, V::LifeStage::Child, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonBoyWhite},
    {{V::Ethnicity::CELTIC, V::LifeStage::Child, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonGirlWhite},
    {{V::Ethnicity::EGYPTIAN, V::LifeStage::Adult, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonEgyptianMaleA1},
    {{V::Ethnicity::EGYPTIAN, V::LifeStage::Adult, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonEgyptianFemaleA1},
    {{V::Ethnicity::GREEK, V::LifeStage::Adult, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonGreekMaleA1},
    {{V::Ethnicity::GREEK, V::LifeStage::Adult, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonGreekFemaleA1},
    {{V::Ethnicity::INDIAN, V::LifeStage::Adult, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonAmericanMaleA1},
    {{V::Ethnicity::INDIAN, V::LifeStage::Adult, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonAmericanFemaleA1},
    {{V::Ethnicity::JAPANESE, V::LifeStage::Adult, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonJapaneseMaleA1},
    {{V::Ethnicity::JAPANESE, V::LifeStage::Adult, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonJapaneseFemaleA2},
    {{V::Ethnicity::NORSE, V::LifeStage::Adult, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonNorseMaleA1},
    {{V::Ethnicity::NORSE, V::LifeStage::Adult, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonNorseFemaleA1},
    {{V::Ethnicity::NORSE, V::LifeStage::Child, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonBoyWhite},
    {{V::Ethnicity::NORSE, V::LifeStage::Child, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonGirlWhite},
    {{V::Ethnicity::TIBETAN, V::LifeStage::Adult, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonTibetanMaleA1},
    {{V::Ethnicity::TIBETAN, V::LifeStage::Adult, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonTibetanFemaleA2},
    {{V::Ethnicity::AFRICAN, V::LifeStage::Adult, V::Sex::MALE, V::Role::NONE}, MeshPackId::PersonEgyptianMaleA1},
    {{V::Ethnicity::AFRICAN, V::LifeStage::Adult, V::Sex::FEMALE, V::Role::NONE}, MeshPackId::PersonEgyptianFemaleA1},
};

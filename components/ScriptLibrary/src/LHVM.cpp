...
void LHVM::SaveState(const std::filesystem::path& filepath)
{
	...
	LHVMFile file(LHVMVersion::BlackAndWhite, _variablesNames, _instructions, _auto, _scripts, _data, _mainStack,
	              _variables, tasks, _ticks, _currentLineNumber, _highestTaskId, _highestScriptId, _executedInstructions);
	file.Write(filepath);
}
